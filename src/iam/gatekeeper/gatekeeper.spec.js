...
describe("Gatekeeper", () => {
    ...
    beforeEach(() => {
        routeDefinitions = {
            "/": { handler: sinon.spy(), permissions: [], secure: false },
            "/open": { handler: sinon.spy(), permissions: [], secure: false },
            "/secure": { handler: sinon.spy(), permissions: ["access_secure"], secure: true }
        };
